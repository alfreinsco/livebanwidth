<x-layouts.app>
    <div class="mb-6">
        <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Tambah MikroTik</h1>
                <p class="text-sm text-gray-600 mt-1">Tambahkan router MikroTik baru untuk monitoring</p>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="port" value="{{ old('port', 8728) }}" min="1" max="65535"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                                placeholder="8728">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                            placeholder="Keterangan tambahan tentang router ini">{{ old('description') }}</textarea>
                    </div>
