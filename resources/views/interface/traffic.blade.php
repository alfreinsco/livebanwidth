<x-layouts.app>
            ...
            <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm font-mono text-gray-800">{{ $interfaceDetail['mac-address'] ?? 'N/A' }}</p>
                    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <div class="w-full bg-white/20 rounded-full h-2">
                <div class="bg-white rounded-full h-2 transition-all duration-300" id="tx-bar" style="width: 0%"></div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <div class="w-full bg-white/20 rounded-full h-2">
                <div class="bg-white rounded-full h-2 transition-all duration-300" id="rx-bar" style="width: 0%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
                <span class="text-xs text-gray-500">Update setiap 2 detik</span>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Upload (TX)</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Download (RX)</th>
    ...
    <script>
        ...
        // Start fetching data
        fetchTrafficData();
        setInterval(fetchTrafficData, 2000); // Update every 2 seconds
    </script>
</x-layouts.app>
